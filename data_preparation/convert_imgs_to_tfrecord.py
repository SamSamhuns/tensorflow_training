...
from dataset_utils import convert_dataset_to_tfr_single_proc, convert_dataset_to_tfr_mult_proc
...
def convert_to_tfrecord(img_dir_path, tfrecord_dir_path, cls_map_path, num_samples_per_shard, use_mult):
    ...
    print(f'Converted data in {img_dir_path} to tfrecords in {tfrecord_dir_path} in {t1- t0:.2f}s')
...
def main():
    ...
    parser.add_argument('--ns', '--num_samples_per_shard',
                        type=int, dest='num_samples_per_shard', default=100,
    ...
    convert_to_tfrecord(args.source_dir_path, args.tfrecord_dir_path,
                        args.cmap_txt_path, args.num_samples_per_shard,
